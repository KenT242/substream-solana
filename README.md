...
all done
```
- Example filter transaction
``` bash
substreams run https://spkg.io/streamingfast/solana-explorer-v0.2.0.spkg \
    map_filter_transactions -e mainnet.sol.streamingfast.io:443 \
    --start-block 153000028 --stop-block +1
```

``` bash
substreams run ./substreams.yaml \                                                
map_filter_transactions -e mainnet.sol.streamingfast.io:443 \
    --start-block 153000028 --stop-block +1
```
...
``` bash
substreams run ./substreams.yaml map_filter_instructions -e mainnet.sol.streamingfast.io:443 --start-block 153000028 --stop-block +1
```

``` bash
substreams run ./substreams.yaml map_filter_instructions -e mainnet.sol.streamingfast.io:443 --start-block 295873726 --stop-block +1
```

- Example filter block full
``` bash
substreams run ./substreams.yaml map_block_full -e mainnet.sol.streamingfast.io:443 --start-block 296110272 --stop-block +1
```

- Example filter transaction
``` bash
substreams run ./substreams.yaml map_filter_transactions -e mainnet.sol.streamingfast.io:443
```
